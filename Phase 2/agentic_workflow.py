...
agents = [
    {"name": "Product Manager", "description": "Responsible for defining product personas and user stories only. Does not define features or tasks. Does not group stories", "func": lambda x: product_manager_support_function(x)},
    {"name": "Program Manager", "description": "Responsible for defining product features by grouping user stories. Does not define individual stories or tasks.", "func": lambda x: program_manager_support_function(x)},
    {"name": "Development Engineer", "description": "Responsible for defining development tasks and engineering work required to implement user stories.", "func": lambda x: development_engineer_support_function(x)}
]
routing_agent = RoutingAgent(openai_api_key=openai_api_key, agents=agents)
